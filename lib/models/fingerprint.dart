...
class Fingerprint extends DataEquality {
  /// The unique String that represents your organizazion.
  final String organizationId;

  /// This value is autogenerated or it can be provided.
  /// It holds an unique Id for this attempt of generating a fingerprint.
  /// The sessionId is important for later, when you submit a payment request.
  final String sessionId;

  /// MobileApplication is all the information used to represent this device
